...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {PhD in Computer Science (Machine Learning) — Sobresaliente (highest grade), Cum Laude}{Sept. 2019 -- July 2022}
      \resumeItemListStart
        \resumeItem{Conducted research in machine learning, with a focus on deep learning, streaming time-series forecasting, and online learning.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Selected coursework: Data Engineering, Machine Learning, Data Visualisation, Unstructured Data Analysis, Big Data.}
        \resumeItem{Thesis: Asynchronous framework for the application of Deep Learning to streaming data.}
      \resumeItemListEnd
    \resumeSubheading
      {Middlesex University}{London, UK}
      {B.Sc. in Computer Science (Erasmus year abroad)}{Sept. 2017 -- Jun. 2018}
      \resumeItemListStart
        \resumeItem{Selected coursework: Open Source Software, Quantum Information Theory, Artificial Intelligence.}
      \resumeItemListEnd
    \resumeSubheading
      {University of Seville}{Seville, Spain}
      {B.Sc. in Computer Science (Software Engineering) — 8.55/10}{Sept. 2014 -- Jun. 2018}
      \resumeItemListStart
        \resumeItem{Selected coursework: Statistics, Data Structures \& Algorithms, Artificial Intelligence.}
        \resumeItem{Thesis: Biomedical data analysis with deep learning.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
  {\small \textbf{Academic record}: PhD (Sobresaliente, Cum Laude) · MSc 9.26/10 · BSc 8.55/10 · EBAU/Selectividad 11/14 · Bachillerato 7.37/10}\\
...
\section{Awards}
  \resumeSubHeadingListStart
      ...
      \resumeSubheadingTwo{Selected for the Spanish FPU Fellowship (national competition)}{Top 30 Computer Science pre-doctoral awards; 4-year scholarship.}{2020}
      {Ministry of Science, Innovation and Universities; Government of Spain}{}
      \vspace{-0.5em}
      
      \resumeSubheading{Winner of OpenWebinars' Prize and \nth{2} Prize in Start-up Hackathon "Hack for good".}{2017}
