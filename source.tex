...
\section{Technical Proficiencies}
  ...
  \resumeSubItem{\textbf{Machine Learning:} Deep Learning, CNN, RNN, Transformers, Regression, data engineering ...}
...
\section{Awards}
  \resumeSubHeadingListStart
      \resumeSubheadingTwo{Selected as one of the top 30 pre-doctoral student nationwide for a 4-year research}{fellowship (FPU). }{2020}
...
\section{Languages}
  ...
  \resumeSubItem{\textbf{English} (Advance C1), \textbf{Italian} (Basic B1), \textbf{Spanish} (Native)  }
