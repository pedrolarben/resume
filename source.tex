...
\section{Awards}
  \resumeSubHeadingListStart
      ...
      \resumeSubheading{Winner of OpenWebnars' Prize and 2nd Prize in Start-up Hackathon "Hack for good".}{2017}
      ...
      \resumeSubheading{1st Prize in Code Competition "Everis Codefest Sevilla".}{2016}
      {Everis}{}
...
\section{Languages}
  ...
  \resumeSubItem{\textbf{Spanish:} Native.}
  
  \resumeSubItem{\textbf{English:} Advance (C1).}
  
  \resumeSubItem{\textbf{Italian:} Basic (B1).}
